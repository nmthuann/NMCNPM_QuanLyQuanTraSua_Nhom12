...
<body>
		...
		<section class="header-middle">
			<div class="container d-flex jc-space-between ai-center">
				...
				<ul class="header-right  d-flex jc-space-between ai-center">
					...
					<li><a href="account/login.htm"><i class="fa-solid fa-user"></i></a></li>
	...
	<main class="main login-container">
		<div class="container">
			...
			<form:form class="login-form" action="account/forgotpassword.htm" modelAttribute="account">
				...
				<span class="errors"><form:errors path="userName"/>${message }</span>
				<button>Send</button>
			</form:form>
		</div>
	</main>
