...
<body>    
    <aside class="aside">
        <a href="admin/account-infor.htm" class="admin">
            <div class="logo">
                <i class="fa-solid fa-t"></i>
            </div>
            ${account.employeeEntity.getLastName() }
        </a>
        <ul class="functions">
            <li class="function">
                <a href="admin/account_infor.htm" class=" active">
                    <div class="icon">
            ...
            <li class="function">
                <a href="admin/changepassword.htm" class="">
                    <div class="icon">
        ...
        <form>
        	<button class="btn-log-out"><a href="admin/logout.htm">Log out</a></button>
        </form>
    </aside>
    ...
    <main class="main">
        <div class="main-header">
            ...
            <div class="map">
                ...
                /
                <a href="user/userHome.htm">${account.employeeEntity.getLastName() }</a>
                /
        ...
        <div class="main-content">
            <form action="user/changepassword.htm">
               ...
               <p>${message1 }</p>
                ...
                <p>${message3 }</p>
                <button name="btnChange" type="submit">Change</button>
                <h2>${message }</h2>
            </form>
