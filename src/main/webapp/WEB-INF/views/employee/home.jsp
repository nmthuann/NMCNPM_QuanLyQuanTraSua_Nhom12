...
<!-- onclick="tai_lai_trang()" -->
	...
	<nav class="sidebar" >
		<div class="text" >Sweet MilkTea</div>
		<ul>

			<li><a href="#" class="feat-btn">Danh Mục <span
					class="fas fa-caret-down first"></span>
			</a>
				<ul class="feat-show">
					<li><a href="admin/drink.htm">Đồ uống</a></li>
					<li><a href="admin/drink">Order</a></li>
				</ul></li>

			<li class="active"><a href="admin/employeepage.htm">Nhân Viên</a></li>

			<li><a href="admin/seat.htm">Bàn</a></li>

			<li><a href="admin/customer.htm">Khách Hàng</a></li>

			<li><a href="admin/position.htm">Bảng Chức Vụ</a></li>

			<li><a href="#" class="serv-btn">Thống kê <span
					class="fas fa-caret-down second"></span>
			</a>
				<ul class="serv-show">
					<li><a href="admin/bill">Thống kê Hóa Đơn</a></li>
					<li><a href="admin/total">Thống kê Doanh Thu</a></li>
				</ul></li>



			<li><a href="admin/login.htm">Đăng Nhập</a></li>
			<li><a href="admin/register.htm">Tạo tài Khoản</a></li>
			<li><a href="admin/other.htm">Thiết lập</a></li>

			<li><a href="admin/email_request.htm">Phản Hồi</a></li>
