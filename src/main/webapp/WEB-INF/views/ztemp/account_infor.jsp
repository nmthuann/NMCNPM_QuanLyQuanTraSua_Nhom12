...
<body>
    ${message }
    <aside class="aside">
        <a href="account/account_infor.htm" class="admin">
            <div class="logo">
        ...
        <ul class="functions">
            <li class="function">
                <a href="account/account_infor.htm" class=" active">
                    <div class="icon">
    ...
    <main class="main">
        <div class="main-header">
            ...
            <div class="map">
                ...
                /
                <a href="user/home.htm">${account.getUserName() }</a>
            </div>
        </div>
        ...
        <div class="main-content">
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <input name = "Username" type="text" placeholder= "Username" value="${account.getUserName() }" readonly>
                    <input name="FullName" type="text" placeholder="FullName" value= "${account.getEmployeeEntity().getFirstName() } ${ account.employeeEntity.getLastName()}" readonly>
                    <%-- <input name ="Role" type="text" placeholder="Role" value= "${infor.employeeEntity.position.getPositonName()}"  readonly> --%>
                ...
                <div class="col-4">
                    <input type="date" placeholder="Birthday" value="${account.employeeEntity.getBirthday() }" readonly>
                    <input type="number" placeholder="Phone" value= "${account.employeeEntity.getPhone() }" readonly>
                    <input type="text" placeholder="Address" value= "${account.employeeEntity.getAddress() }" readonly>
                </div>
            </div>
